...
namespace D6UWHX_HFT_2021221.Data
{
    ...
    public class MusicLibraryContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Album a7 = new Album() { AlbumID = 77, Title = "Title 7 " , TracktID = 1 };
            Album a8 = new Album() { AlbumID = 88, Title = "Title 8 " , TracktID = 1 };
            Album a9 = new Album() { AlbumID = 99, Title = "Title 9 " ,TracktID = 1 };
            Album a10 = new Album() { AlbumID = 100, Title = "Title 10 ", TracktID = 1 };
            //Track
            ...
            modelBuilder.Entity<Album>().HasData(a1 , a2 ,a3 ,a4, a5 , a6 , a7 , a8 ,a9 ,a10);
